          ...
          <div className="md:flex select-none">
            ...
            <div className="md:w-1/2 p-6">
              ...
              <div className="flex flex-wrap gap-x-5 my-3">
                <button
                  className="bg-black text-white px-5 py-2 rounded-full hover:bg-neutral-800 hover:-translate-y-1.5 
                  active:translate-y-0 transition-transform duration-200 ease-in-out active:duration-0 active:ease-linear"
                  onClick={addtocart}
                >
                  Add to Cart
                </button>
